...
/**
 * The type of event to start the animation.
...
/**
 * The type of event to finish the animation.
 * @enumcategory Animation events
...
/**
 * The type of event to move with the mouse on the point.
 * @enumcategory Point event types
...
/**
 * The type of event for double-clicking a point.
 * @enumcategory Point event types

 ...
 * @enumcategory Animation event types
 * @enumexample anychart.enums.EventType.animation AnimationStart
 */
 ...
 * Works for {api:anychart.charts} all charts{api} that use the {@link anychart.core.Chart#animation} method.
 * @enumcategory Animation event types
 * @enumexample anychart.enums.EventType.animation AnimationEnd
 */
...
/**
 * Event type for point at leading off mouse.<br/>
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.point_pointmouse_over_out PointMouseOut
 */
anychart.enums.EventType.POINT_MOUSE_OUT = "pointMouseOut";

/**
 * Event type for point at hover mouse.<br/>
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointmouse_over_out PointMouseOver
 */
anychart.enums.EventType.POINT_MOUSE_OVER = "pointMouseOver";

/**
 * The type of event to move with the mouse on the point.<br/>
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointmousemove_dblclick PointMouseMove
 */
 ...
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointmousemove_dblclick PointDblclick
 */
anychart.enums.EventType.POINT_DBLCLICK = "pointDblclick";

/**
 * Event type for point at down mouse.<br/>
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointMouseDown_pointMouseUp PointMouseDown
 */
anychart.enums.EventType.POINT_MOUSE_DOWN = "pointMouseDown";

/**
 * Event type for point at up mouse.<br/>
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointMouseDown_pointMouseUp PointMouseUp
 */
 ...
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointsHover_pointClick PointsHover
 */
 ...
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointsHover_pointClick PointClick
 */
 ...
 * Works for all charts and series that use the getPoint() method.
 * @enumcategory Point event types
 * @enumexample anychart.enums.EventType.pointsSelect PointsSelect
 */
...
/**
 * Event type for scrolling.
 */
anychart.enums.EventType.SCROLLING = "scrolling";

/**
 * Event type for scroll end.
 */
anychart.enums.EventType.SCROLL_END = "scrollEnd";

 ...
 * @shortDescription Resource list settings.
 * @category Specific settings
 * @example anychart.charts.Resource.resourceList_get
 * @return {anychart.core.resource.ResourceList} Resource list.
 */
anychart.charts.Resource.prototype.resourceList;
 ...
 *   <li><b>string</b> - sets resource list settings.</li>
 * </ul>
 ...
 * @param {(string|Object|null|boolean)=} opt_settings Resource list settings to set.

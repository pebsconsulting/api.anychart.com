 ...
 * @typedef {Object} anychart.core.ui.Tooltip.UnionFormatConext
 ...
 * @name unionFormatF
 * @this string|number
 * @param {anychart.core.ui.Tooltip.UnionFormatConext} this This param.
 */
 ...
 * @param {unionFormatF} opt_unionFormat Function or string token ('{%joinedFormattedValues}') to format content text.

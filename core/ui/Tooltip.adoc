 ...
 * Use {api:anychart.core.ui.Tooltip#onDomReady}tooltip.useHtml(true){api} to work with onDomReady handler.<br/>
 * The method is called once when all the inner elements have been created.<br/>
 * See the structure of the inner HTML-tooltip elements at the {api:anychart.core.ui.Tooltip#onDomReady}useHtml() method{api}.
 ...
 * Use {api:anychart.core.ui.Tooltip#onDomReady}tooltip.useHtml(true){api} to work with onBeforeTitleChange handler.<br/>
 ...
 * Use {api:anychart.core.ui.Tooltip#onDomReady}tooltip.useHtml(true){api} to work with onTitleChanged handler.<br/>
 ...
 * Use {api:anychart.core.ui.Tooltip#onDomReady}tooltip.useHtml(true){api} to work with onBeforeContentChange handler.<br/>
 ...
 * Use {api:anychart.core.ui.Tooltip#onDomReady}tooltip.useHtml(true){api} to work with onContentChanged handler.<br/>

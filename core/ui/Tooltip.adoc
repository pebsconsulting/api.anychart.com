 ...
 * @typedef {Object} anychart.core.ui.Tooltip.UnionFormatContext
 * @property {string} dataIntervalUnit dataIntervalUnit
 * @property {number} dataIntervalUnitCount dataIntervalUnitCount
 * @property {Array.<string>} formattedValues formattedValues
 * @property {number} hoveredDate hoveredDate
 * @property {boolean} isGrouped isGrouped
 * @property {string} joinedFormattedValues joinedFormattedValues
 * @property {Array} points points
 * @property {number} rawHoveredDate rawHoveredDate
 * @property {string} titleText titleText
 * @property {number} valuePostfix valuePostfix
 * @property {number} valuePrefix valuePrefix
 * @property {number} x x
 * @since 7.11.0
 */

/**
 * Union format function.
 * @typedef {function}
 * @name unionFormatFunction
 * @this string|number|Array.<string>
 * @param {anychart.core.ui.Tooltip.UnionFormatContext} this This param.
 */
 ...
 * @param {unionFormatFunction} opt_unionFormat Function or string token ('{%joinedFormattedValues}') to format content text.

 ...
 * @typedef {Object} anychart.core.ui.Tooltip.UnionFormatFunctionThis
 * @property {string} dataIntervalUnit dataIntervalUnit
 * @property {number} dataIntervalUnitCount dataIntervalUnitCount
 * @since 7.11.0
 */
anychart.core.ui.Tooltip.UnionFormatFunctionThis;

/**
 * Union format function.
 * @typedef {function}
 * @name UnionFormatFunction
 * @param {anychart.core.ui.Tooltip.UnionFormatFunctionThis} this This data item.
 */

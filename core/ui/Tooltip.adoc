 ...
 * @typedef {Object} anychart.core.ui.Tooltip.UnionFormatFunctionParam
 * @property {string} dataIntervalUnit dataIntervalUnit
 * @property {number} dataIntervalUnitCount dataIntervalUnitCount
 * @since 7.11.0
 */
anychart.core.ui.Tooltip.UnionFormatFunctionParam;

/**
 * Union format function.
 * @typedef {function}
 * @name UnionFormatFunction
 * @param {anychart.core.ui.Tooltip.UnionFormatFunctionParam} this This data item.
 */

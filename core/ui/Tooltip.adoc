 ...
 * (https://cdn.anychart.com/releases/latest/css/anychart-ui.min.css for latest or https://cdn.anychart.com/releases/8.3.0/css/anychart-ui.min.css for the versioned file)

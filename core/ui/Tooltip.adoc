 ...
 * @typedef {Object} anychart.core.ui.Tooltip.aUnionFormatFunctionParam
 * @property {string} dataIntervalUnit dataIntervalUnit
 * @property {number} dataIntervalUnitCount dataIntervalUnitCount
 * @since 7.11.0
 */
anychart.core.ui.Tooltip.aUnionFormatFunctionParam;

/**
 * Union format function.
 * @typedef {function}
 * @name unionFormatFunction
 * @param {anychart.core.ui.Tooltip.aUnionFormatFunctionParam} pr This data item.
 */

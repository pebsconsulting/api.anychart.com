 ...
 * @typedef {Object} anychart.core.ui.Tooltip.aUnionFormatFParam
 * @property {string} dataIntervalUnit dataIntervalUnit
 * @property {number} dataIntervalUnitCount dataIntervalUnitCount
 * @since 7.11.0
 */
anychart.core.ui.Tooltip.aUnionFormatFParam;

/**
 * Union format function.
 * @typedef {function}
 * @name unionFormatF
 * @param {anychart.core.ui.Tooltip.aUnionFormatFParam} this This data item.
 */

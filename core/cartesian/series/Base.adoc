 ...
 * @param {string} opt_xMode ['ordinal'] X mode to set. X mode can be take on two values: 'ordinal' and 'scatter'.<br/>
 * <b>'scatter'</b> - if the data contain several points in the same-named category then all these points are drawn<br/>
 * <b>'ordinal'</b> - if the data contain several points in the same-named category then only the last point is drawn
 * @return {anychart.core.cartesian.series.Base} Self instance for method chaining.
 * @since 8.4.1
 */
anychart.core.cartesian.series.Base.prototype.xMode;

 ...
 * The xMode() method is used to define points behavior when several points are in the same-named category.
 * @example anychart.core.cartesian.series.Base.xMode
 * @param {string} opt_xMode ['ordinal'] X mode to set. X mode can be take on two values: 'ordinal' and 'scatter'.
 * <br><table border="1">
 * <tr><td><p><b>Value</p>
 * </td><td><p><b>Description</p>
 * </td>
 * </tr>
 * <tr><td><p>Scatter</p>
 * </td><td><p>if the data contain several points in the same-named category then all these points are drawn</p>
 * </td>
 * <tr><td><p>Ordinal</p>
 * </td><td><p>if the data contain several points in the same-named category then only the last point is drawn</p>
 * </td>
 * </tr>
 * </table>
 * @return {anychart.core.cartesian.series.Base} Self instance for method chaining.
